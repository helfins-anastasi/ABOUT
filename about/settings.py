...
# username login setup to bypass local issue with social login 
SOCIAL_AUTH_USERNAME_FORM_URL = '/secret-login-form/'
...
db_from_env = dj_database_url.config(default='postgresql: postgres', conn_max_age=500)
